...
<html>
	<head>
		<title>Thi thử bằng Mô Tô</title>
	...
	if (isset($_POST['sub']))
	{
		...
		foreach ($arr as $key => $value)
		{
			...
			//echo $c;
				//echo substr($key, -3) ;
				//echo strpos($key, "_");
				$sql1 = "select dapandung1 from cauhoimoto where id ='$key' limit 1";
...
?>
	...
	mysqli_set_charset($conn, 'UTF8');
		$sql="select a.id,a.cauhoi,b.dapan1,b.dapan2,b.dapan3,b.dapan4 from cauhoimoto as a inner join dapan as b  order by rand() LIMIT 1,20";
