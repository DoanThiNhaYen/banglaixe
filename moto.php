	...
	<head>
		...
		<style>
			*{
			...
			.moto img{
				width:300px;
				animation:moto 1s linear infinite;
			}
			@keyframs moto{
				100%{
	...
	<body>
		<form>
			<div class="hero">
				...
				<div class="moto">
					<img src="73185233_1395729680603906_675194255072821248_n.png">
				</div>
				
			</div>
			<h3>365 CÂU HỎI THI SÁT HẠCH LÁI XE MÔ TÔ</h3>
			<div>
			<?php
			...
			$caulenhphantrang="select * from cauhoimoto LIMIT $vt, $sodongtrentrang";
			...
			while($row=mysqli_fetch_array($kqpt))
			{
				...
				$cau=$row['cauhoi'];
					...
					echo "<tr><td>Câu ".$row['id']."</td></tr>
						<tr><td><img src='/BT/365 câu/$cau'/height='400' width='740'></td></tr>
...
?>			
		...
		<div class="row">
			<div class="col-md-10">
				...
				<ul class="pagination">
				<li>
					<a href="moto.php?trangchon=<?=$Previous; ?>" aria-label="Previous">
						<span aria-hidden="true">Previous </span>
					</a>
				</li>
			
			<?php for($i=0;$i<=$sotrangdulieu;$i++):?>
				<li><a href="moto.php?trangchon=<?=$i; ?>"><?=$i; ?></a></li>
				<?php endfor; ?>
				<li>
					<a href="moto.php?trangchon=<?=$Next; ?>" aria-label="Next">
