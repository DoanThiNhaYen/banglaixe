	...
	<body>
			...
			if(isset($_POST['sub2']))
			{
				...
				if ($hinhanh != null)
				{
					...
					//move_uploaded_file($tmp_name,$path.$hinhanh);
						$sql="update cauhoixemay set cauhoi='".$hinhanh."', dapandung1='".$dapan."' where id='$_GET[id]'";
		...
		<form method="POST" enctype="multipart/form-data">
			<div id="addbox">
				<h1>Sửa câu hỏi</h1>
				<p>Mã câu hỏi</p>
				<input type="text" name="macauhoi" id="macauhoi" value="<?php echo $_GET['id'];?>" required>
				...
				<input type="submit" name="sub2" id="sub2" value="Sửa">
			</div>
		</form>
