...
<html>
	<head>
		<title>Thi thử bằng Xe Máy</title>
...
?>
	...
	mysqli_set_charset($conn, 'UTF8');
		$sql="select a.id,a.cauhoi,b.dapan1,b.dapan2,b.dapan3,b.dapan4 from cauhoixemay as a inner join dapan as b  order by rand() LIMIT 1,20";
	...
	<?php	}	?>	
			...
			<div id="footer">
			<label><?php echo "Tên Đăng Nhập: " . $_SESSION['ten'];?></label><br>
			<label>Hạng Thi:A1</label>
