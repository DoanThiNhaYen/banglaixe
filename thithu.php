...
<html>
	...
	if (isset($_POST['sub']))
	{
		...
		foreach ($arr as $key => $value)
		{
			//$search = "_";
			//$replace = " ";
			//$c= str_replace($search, $replace, $key);
			//echo $key;
				//echo substr($key, -3) ;
				//echo strpos($key, "_");
				$sql1 = "select dapandung1 from cauhoioto where id='$key' limit 1";
		...
		echo "<br> <script>alert('đúng $dung, sai $sai')</script>";
	}
?>
	...
	mysqli_set_charset($conn, 'UTF8');
		$sql="select a.id,a.cauhoi,b.dapan1,b.dapan2,b.dapan3,b.dapan4 from cauhoioto as a inner join dapan as b  order by rand() LIMIT 1,20";
